  ...
  function generate ($email) {
    ...
    // );
     ...
     try {
       ...
       //Recipients
       $mail->setFrom('mahusayjograd@gmail.com', 'PEESE WEB APP');
       $mail->addAddress($email);
 
       // Content
       $mail->isHTML(true);
       $mail->Subject = 'PEESO WEB APP REGISTRATION';
       $mail->Body    = "Your OTP is $pass. Enter at <a href='http://localhost/3b-challenge.php'>SITE</a>.";
       $mail->AltBody = "Your OTP is $pass. Enter at http://localhost/3b-challenge.php.";
